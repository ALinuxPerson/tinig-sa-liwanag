...
| `src_podcast_01` | TBD | TBD | TBD | `native_podcast` | TBD | Exclude music/intro/outro; verify redistribution before use |
| `src_vlog_01` | TBD | TBD | TBD | `native_vlog` | TBD | Everyday speech; verify redistribution before use |
